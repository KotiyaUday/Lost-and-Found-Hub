...
const UserProfile = () => {
  ...
  return (
    ...
    <div className="h-screen w-full bg-gray-100 flex overflow-y-visible">
      {/* Empty space for slider */}
      <div className="w-100 bg-transparent">
            <Sideheader />
        </div> {/* <-- Reserve left space */}
      {/* Main content */}
      <div className="flex-1 flex flex-col items-center">
        ...
        <div className="w-full max-w-6xl mt-8 px-4 h-[80vh] overflow-y-auto rounded-lg mb-2 pb-2" style={{ scrollbarWidth: "none" }}>
